...
```bash
# Mode 1: Review & Audit an existing profile (Default)
/linkedin-optimizer
# Auto-discovers your LinkedIn URL from your profile and generates a structured critique & before/after upgrades.

# Mode 2: Generate a complete 100/100 turnkey profile specification
/linkedin-optimizer generate "IT Systems Administrator"
```

For full architecture details, deep-dive flowcharts, and 2026 recruiter search heuristics, see [`LINKEDIN_OPTIMIZER.md`](LINKEDIN_OPTIMIZER.md) and [`LINKEDIN_OPTIMIZATION_PLAYBOOK.md`](LINKEDIN_OPTIMIZATION_PLAYBOOK.md).
