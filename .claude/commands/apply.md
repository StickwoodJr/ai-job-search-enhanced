...
8. **Automatically Update & Deploy Dashboard.** Run `python3 scripts/rebuild_dashboard.py` (or `./scripts/deploy_dashboard.sh` when `DASHBOARD_REPO` is configured) to update `reports/application-dashboard.html` and optionally publish to GitHub Pages.
